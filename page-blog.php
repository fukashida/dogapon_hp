...
<div id="wrapBlog" class="wraplineBG">
    <div class="swiper-container pc wrapMV">
            ...
            <div class="swiper-wrapper">
                    <!-- Slides -->
                    <div class="swiper-slide"><a href="<?php echo home_url(); ?>/tag/voice"><img src="<?php echo get_template_directory_uri(); ?>/images/blog/slide1_pc.jpg"></a></div>
                    <div class="swiper-slide"><a href="<?php echo home_url(); ?>/tag/voice"><img src="<?php echo get_template_directory_uri(); ?>/images/blog/slide2_pc.jpg"></a></div>
                <div class="swiper-slide"><a href="<?php echo home_url(); ?>/counseling"><img src="<?php echo get_template_directory_uri(); ?>/images/blog/slide3_pc.jpg"></a></div>
            </div>
    ...
    <div class="swiper-container tab-sp wrapMV">
            ...
            <div class="swiper-wrapper">
                    <!-- Slides -->
                <div class="swiper-slide"><a href="<?php echo home_url(); ?>/tag/voice"><img src="<?php echo get_template_directory_uri(); ?>/images/blog/slide1_sp.jpg"></a></div>
                        <div class="swiper-slide"><a href="<?php echo home_url(); ?>/tag/voice"><img src="<?php echo get_template_directory_uri(); ?>/images/blog/slide2_sp.jpg"></a></div>
                        <div class="swiper-slide"><a href="<?php echo home_url(); ?>/counseling"><img src="<?php echo get_template_directory_uri(); ?>/images/blog/slide3_sp.jpg"></a></div>
            </div>
